...
POUR_WATER_AUDIO_HALF = {
    "task_name": "pour_water_audio_half",
    "task_description":
    "Use both arms to simultaneously pick up the bottle1 and bottle2 and move them to the front target locations, \
                        with the bottle1 on the left and the bottle2 on the right.\
                        Note: You don't need to open gripper and don't put down the bottles at the end.",
    "current_code": """
                class gpt_pour_water_audio_half(pour_water_audio_half):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
...
POUR_WATER_AUDIO_FULL = {
    ...
    "Use both arms to simultaneously pick up the bottle1 and bottle2 and move them to the front target locations, \
                        ...
                        Note: You don't need to open gripper and don't put down the bottles at the end.",
    "current_code": """
                class gpt_pour_water_audio_full(pour_water_audio_full):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
...
TOUCH_PLATE = {
    "task_name": "touch_plate",
    "task_description":
    "There are two blocks on the desk. Use the left arm to grab the block and move it to the handover point, then use right arm to grab the block and open the gripper of left arm simutaniously.\
                        Use right arm move block on the target block.\
                        Note: You should first pass the block to the right gripper and close right gripper, then open the left gripper.",
    "current_code": """
                class gpt_touch_plate(touch_plate):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
...
CLICK_ALARMCLOCK_AUDIO = {
    "task_name": "click_alarmclock_audio",
    "task_description": "To turn off the alarm when it rings, follow these steps:\
                        Click the alarm clock's center of the top side button on the table.\
                        Move the top of bell's center and close gripper. And move the gripper down.\
                        Note: You can change some API parameters to move above the alarm clock's top center and close the gripper(grasp_actor).\
                        You can use self.grasp_actor() to simulate the action of touch and click",
    "current_code": """
                class gpt_click_alarmclock_audio(click_alarmclock_audio):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
...
CLICK_ALARMCLOCK_AUDIO_SINGLE = {
    "task_name": "click_alarmclock_audio_single",
    "task_description": "To turn off the alarm when it rings, follow these steps:\
                        Click the alarm clock's center of the top side button on the table.\
                        Move the top of bell's center and close gripper. And move the gripper down.\
                        Note: You can change some API parameters to move above the alarm clock's top center and close the gripper(grasp_actor).\
                        You can use self.grasp_actor() to simulate the action of touch and click",
    "current_code": """
                class gpt_click_alarmclock_audio_single(click_alarmclock_audio_single):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
...
OPEN_MICROWAVE_AUDIO = {
    "task_name": "open_microwave_audio",
    "task_description": "Open the microwave with one proper arm.\
                        Grasp the handle of the microwave with specified arm. Pull the handle to open the microwave",
    "current_code": """
                class gpt_open_microwave_audio(open_microwave_audio):
                    def play_once(self):
                        pass
                """,
    "actor_list": {
