...
class pour_water_audio_full(Base_Task):
    def setup_demo(self, **kwags):
        super()._init_task_env_(**kwags)
        self.pour_audio_path = os.path.join("assets", "audios", "pour_water_full.mp3")
    ...
    def play_once(self):
        ...
        self._wait_and_update(7.8, save_freq=self.save_freq)
