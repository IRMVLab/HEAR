...
class TrainingArguments(transformers.TrainingArguments):
    ...
    # logger
    logging_dir: str = field(default='./logs')  # Directory used for TensorBoard logs.
    logging_strategy: str = field(default='steps')  # Log metrics every fixed number of steps.
    logging_steps: int = field(default=10)

    save_steps: int = field(default=10)  # Save a checkpoint every N steps.
