...
DATA_DIR = os.environ.get("TINYVLA_DATA_DIR", str(POLICY_ROOT / "data"))
PRETRAIN_DIR = os.environ.get("TINYVLA_PRETRAIN_DIR", str(POLICY_ROOT / "pretrain"))
LOCAL_DATA_DIR = os.environ.get("TINYVLA_LOCAL_DATA_DIR", str(POLICY_ROOT / "data_local"))

TASK_CONFIGS = {
    "task_name_you_test": {
        'dataset_dir': [os.path.join(DATA_DIR, "sim-/aloha-agilex-1-m1_b1_l1_h0.03_c0_D435-100")],
        'episode_len': 500,
