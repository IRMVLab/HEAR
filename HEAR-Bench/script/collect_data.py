...
def main(task_name=None, task_config=None):
    if not task_name or not task_config:
        raise ValueError("Both task_name and task_config are required.")
...
def parse_args():
    ...
    parser.add_argument("task_name_pos", nargs="?", default=None)
    parser.add_argument("task_config_pos", nargs="?", default=None)
...
if __name__ == "__main__":
    ...
    task_name = parsed_args.task_name or parsed_args.task_name_pos or "click_alarmclock_audio_random"
    task_config = parsed_args.task_config or parsed_args.task_config_pos or "demo_clean_audio"

    main(task_name=task_name, task_config=task_config)

    try:
        cache_dir = os.path.join("data", task_name, task_config, ".cache")
        if os.path.exists(cache_dir):
            shutil.rmtree(cache_dir)
            print(f"Removed cache: {cache_dir}")
    except Exception as e:
        print(f"Failed to remove cache {cache_dir}: {e}")
