...
2. Define a training config that uses the custom dataset.
    ...
    We provide the [pi0_aloha_pen_uncap config](../../openpi/training/config.py) as an example. You should refer to the root [README](../../README.md) for how to run training with the new config.
